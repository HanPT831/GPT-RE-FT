...
from prepro import TBDProcessor
...
def main():
    ...
    parser.add_argument("--data_dir", default="./data/TB-Dense", type=str)
    ...
    parser.add_argument("--run_name", type=str, default="tbd")
    ...
    processor = TBDProcessor(args, tokenizer)
